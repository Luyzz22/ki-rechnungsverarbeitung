...
const PAGE_PATH = "/legal/loesungen";

export const metadata: Metadata = pageMetadata({
  path: "/legal/loesungen",
  title: "Lösungen",
  description:
    "Lösungen von SBS Legal nach Aufgabe: Vertragsanalyse, Legal Operations, AI Governance, Compliance Evidence und Risikomanagement.",
});

export default function LegalSolutions() {
  const solutions = solutionsByDivision("legal");
  return (
    <SiteChrome siteKey="legal" path="/legal/loesungen">
      <Section tone="page" rhythm="wide" labelledBy="titel">
        <SectionHeader
          as="h1"
          id="titel"
          eyebrow="SBS Legal · Lösungen"
          title="Fünf Aufgaben zwischen Vertrag, Prüfung und Governance"
          lead="Diese Seiten beginnen mit dem Problem, nicht mit dem Produktnamen. Sie zeigen den Weg vom Ausgangszustand zum dokumentierten Ergebnis."
          className="mb-11"
        />
